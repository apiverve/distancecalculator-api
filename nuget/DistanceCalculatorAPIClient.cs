...
namespace APIVerve.API.DistanceCalculator
{
    ...
    /// <summary>
    /// Client for the DistanceCalculator API
    /// </summary>
    public class DistanceCalculatorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/distancecalculator";
        ...
        {
            { "lat1", new ValidationRule { Type = "number", Required = true, Min = -90, Max = 90 } },
            { "lon1", new ValidationRule { Type = "number", Required = true, Min = -180, Max = 180 } },
            { "lat2", new ValidationRule { Type = "number", Required = true, Min = -90, Max = 90 } },
            { "lon2", new ValidationRule { Type = "number", Required = true, Min = -180, Max = 180 } }
        };
        ...
        public DistanceCalculatorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DistanceCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DistanceCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DistanceCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DistanceCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(DistanceCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DistanceCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DistanceCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DistanceCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DistanceCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DistanceCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DistanceCalculatorQueryOptions options)
        {
