...
namespace APIVerve\Distancecalculator;
...
/**
 * Client for the Distance Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/distancecalculator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/distancecalculator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DistancecalculatorClient] {$message}\n";
        }
    }
}
