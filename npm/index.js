...
class distancecalculatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/distancecalculator');
        }
        ...
        this.validationRules = {"lat1":{"type":"number","required":true,"min":-90,"max":90},"lon1":{"type":"number","required":true,"min":-180,"max":180},"lat2":{"type":"number","required":true,"min":-90,"max":90},"lon2":{"type":"number","required":true,"min":-180,"max":180}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/distancecalculator`);
        }
    }
...
module.exports = distancecalculatorWrapper;
