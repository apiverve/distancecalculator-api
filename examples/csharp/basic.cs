...
namespace APIVerve.Examples
{
    class DistanceCalculatorExample
    {
        ...
        private static readonly string API_URL = "https://api.apiverve.com/v1/distancecalculator";

        /// <summary>
        /// Make a GET request to the Distance Calculator API
        /// </summary>
        static async Task<JsonDocument> CallDistanceCalculatorAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Distance Calculator API...\n");

            var result = await CallDistanceCalculatorAPI();
