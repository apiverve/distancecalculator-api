// Package distancecalculator provides a Go client for the Distance Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/distancecalculator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Distance Calculator API.
//
// Parameters:
//   - lat1 (required): number - The latitude of the first location [min: -90, max: 90]
//   - lon1 (required): number - The longitude of the first location [min: -180, max: 180]
//   - lat2 (required): number - The latitude of the second location [min: -90, max: 90]
//   - lon2 (required): number - The longitude of the second location [min: -180, max: 180]
type Request struct {
	Lat1 float64 `json:"lat1"` // Required
	Lon1 float64 `json:"lon1"` // Required
	Lat2 float64 `json:"lat2"` // Required
	Lon2 float64 `json:"lon2"` // Required
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"lat1": {Type: "number", Required: true, Min: float64Ptr(-90), Max: float64Ptr(90)},
		"lon1": {Type: "number", Required: true, Min: float64Ptr(-180), Max: float64Ptr(180)},
		"lat2": {Type: "number", Required: true, Min: float64Ptr(-90), Max: float64Ptr(90)},
		"lon2": {Type: "number", Required: true, Min: float64Ptr(-180), Max: float64Ptr(180)},
	}
...
// ResponseData contains the data returned by the Distance Calculator API.
type ResponseData struct {
	DistanceMiles float64 `json:"distanceMiles"`
	DistanceKm float64 `json:"distanceKm"`
	Location1 Location1Data `json:"location1"`
	Location2 Location2Data `json:"location2"`
}

// Location1Data represents the location1 object.
type Location1Data struct {
...
// Location2Data represents the location2 object.
type Location2Data struct {
	Latitude string `json:"latitude"`
	Longitude string `json:"longitude"`
	City string `json:"city"`
	State string `json:"state"`
